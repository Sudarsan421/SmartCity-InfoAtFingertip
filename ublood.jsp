...
<br />
<form action="ublood1.jsp" method="get">
<input type="hidden" name="bld" value="<%=request.getParameter("bld")%>" />
<table> 
<tr><td><span class="style7">Group</span></td>
<td><select name="grp">
...
<tr><td><span class="style7">Rh Factor</span></td>
<td><select name="rh">
<option value="+ve">+ve</option>
<option value="-ve">-ve</option> 
</select></td></tr>
<tr><td><span class="style7">Date to be Given</span></td>
<td><input type="date" name="furdt" /></td></tr>
