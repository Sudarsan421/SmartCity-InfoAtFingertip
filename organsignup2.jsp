...
function verify(){
var s1 = document.f2.pas.value;
var s2 = document.f2.pas1.value;
if(s1==""){
	alert("Enter password.");
	document.f2.pas.focus();
	return false;
}else if(s2==""){
	alert("Enter confirm password.");
	document.f2.pas1.focus();
	return false;
}else if(s1.length<6){
...
<form  name="f2" id="f2" method="get" action="organsignup3.jsp">
	<table width="708">
	<tr> 
		<td>Name </td>
		<td><input type="text" name="name" value="<%=request.getParameter("a2")%>" readonly="true" /></td>
		<td></td>
		<td>Type </td>
		<td><input type="text" name="type" value="<%=request.getParameter("a1")%>" readonly="true" /></td>
	 </tr>
		
		<tr>
		<td>Log Name </td>
		<td><input type="text" name="logna"  /></td>
		<td></td>
	...
	<tr>
		...
		<td>
		<select name="c4">
		<option value="When was your organisation founded?">When was your organisation founded?</option>
		<option value="Who is the head of your organisation?">Who is the head of your organisation?</option>
		<option value="Who is the founder?">Who is the founder?</option>
		<option value="What is your registration number?">What is your registration number?</option>
		</select>		</td>
		<td></td>
		...
		<td></td>
		<td>Pincode</td>
		<td><input type="text" name="pincode" value="<%=request.getParameter("a3")%>" readonly="true"/></td>
	 ...
	 <tr>
	   ...
	   <td><input name="lng" type="text" id="lng"></td>
	    ...
	    <tr>
	   <td>URL</td>
	   <td><input name="text" type="text" id="url"></td>
	   <td></td>
	  
	   </tr>
	   
	 
	<tr><td colspan="5" align="center"><input type="submit" value="SUBMIT" onclick="return verify()"></td></tr>		
	</table>
	</form>
