...
try{
  ...
  String perkm=request.getParameter("perkm");
	...
	String qry="update vehicle set  oname='"+oname+"' , dname='"+dname+"' , bookingnum='"+bno+"' , City='"+city+"' , District='"+dist+"' ,State='"+state+"' ,timing='"+timing+"' , baseprice='"+base+"',perkm='"+perkm+"'  where vid='"+s1+"'";
