...
%>	   
<% 
			 String qry="select * from organisation  where oid='"+name+"'   ";
			// out.print(qry);
...
%>
<h4>Welcome <%= ((String)session.getAttribute("name")).toUpperCase() %> to View <%=rs.getString(2)%> Information!</h4>
            <td><a href="ublood.jsp?bld=<%=name%>" class="myButton">Blood Donation</a></td>
			
<table>
<tr><td>
<table width="515" height="384"  cellpadding="5" bordercolor="#000000">
<tr><td width="120"><span class="style7">Name</span></td> 
<td width="379"><span class="style7"><%=rs.getString(2)%></span></td>
</tr>

<tr><td width="120"><span class="style7">Plot No</span></td>
<td><span class="style7"><%=rs.getString(3)%></span></td>
</tr>

<tr><td width="120"><span class="style7">Area</span></td>
<td><span class="style7"><%=rs.getString(4)%></span></td>
</tr>

<tr><td width="120"><span class="style7">City</span></td>
<td><span class="style7"><%=rs.getString(5)%></span></td>
</tr>

<tr><td width="120"><span class="style7">Pincode</span></td>
<td><span class="style7"><%=rs.getString(6)%></span></td>
</tr>

<tr><td width="120"><span class="style7">District</span></td>
<td><span class="style7"><%=rs.getString(7)%></span></td>
</tr>

<tr><td width="120"><span class="style7">State</span></td>
<td><span class="style7"><%=rs.getString(8)%></span></td>
</tr>

<tr><td width="120"><span class="style7">Phone</span></td>
<td><span class="style7"><%=rs.getString(9)%></span></td>
</tr>

<tr><td width="120"><span class="style7">Mail</span></td>
<td><span class="style7"><%=rs.getString(10)%></span></td>
</tr>
 

<tr><td width="120"><span class="style7">Timing</span></td>
<td><span class="style7"><%=rs.getString(12)%></span></td>
</tr>
</table>			 
...
<h4>View Department Details Here</h4>
			 ...
			 <tr>
			 <td width="354" class="style7">Department Name</td>
			 <td width="144" class="style7">Type</td>
			 <td width="192" class="style7">Timing</td>
			 </tr>
			 <% 
			  qry="select a.*,b.* from dept a,organisation b where a.oid='"+name+"'  and b.oid='"+name+"' ";
			 //out.print(qry);
			 ...
			 %>
			<tr>
			<td height="29" class="style7"><%=rs.getString(3)%></td>
			<td class="style7"><%=rs.getString(4)%></td>
			<td class="style7"><%=rs.getString(5)%></td>
			</tr>
			<% }
            %>  	 
		   </table>
