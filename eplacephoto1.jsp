...
<span class="style9">UPLOAD A PHOTO</span><br>
 <br />
<% 
...
<form action="upphoto" method="post" enctype="multipart/form-data" class="style5">
<table border="1" height="62" width="504">
<tr>
	<td width="155"><span class="style9">Choose the file </span></td>
	<td width="333"><input name="file" type="file"></td>
</tr>
