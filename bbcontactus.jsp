...
<form  name="f2" id="f2" method="get" action="bbcontactus1.jsp">
<img src="fb.jpg" alt="" width="530" height="188" border="1" />
<%
try{
    String s1=(String) session.getAttribute("id");
	String qry="select b.* from login a,organisation b where a.id='"+s1+"' and a.id=b.oid and a.type='BloodBank' ";
	//out.print(qry);
...
<table>
<tr>
<td width="289"><h2>BloodBank Name:</h2></td>
...
<tr><td> <h2>Your Message/Feedback/Suggestion: </h2></td><td> <textarea id="message" name="message" rows="8" cols="70"></textarea>
</td>
</tr>
