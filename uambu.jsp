...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <br />
	<h4>  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to View Ambulance's Around You !</h4> <div class="article">


		<form method="post" action="uambu1.jsp">
			<%
			try{
			  ResultSet rs=st.executeQuery("select a.* from vehicle a,login b where a.vid=b.id and b.status='y' and a.type='Ambulance' and a.availability='Y'");
			 %>	
			 <table>
			<tr><td><span class="style12">Choose Ambulance</span></td>
			<td></td>
			...
			<td><input type="submit"  class="myButton" value="Book Ambulance"></td><td></td><td></td><td></td>
			<td><a href="uprevambu.jsp" class="myButton">Previous Booking</a></td>
			<td><a href="ucurrambu.jsp" class="myButton">Current Booking</a></td>
			</tr>		
			</table>
...
<button class="sort-table desc">Sort Farthest First</button>
			...
			<%}catch(Exception ee){}%>
			 ...
			 <%
			try{
			 ResultSet rs=st.executeQuery("select a .* from vehicle a,login b where a.vid=b.id and b.status='y' and a.type='Ambulance' and a.availability='Y'  limit 15");
			%>	
			...
			<table width="923"  height="65" border="1"  cellpadding="5" id="loctable">
				 <thead>
			<tr>
			<td width="110"><span class="style12">Vehicle Number</span></td> 
			<td width="30"><span class="style12">Model</span></td>
			<td width="40"><span class="style12">Owner</span></td>
			<td width="40"><span class="style12">Driver Name</span></td>
			<td width="68"><span class="style12">Booking Number</span></td>
			<td width="99"><span class="style12">City</span></td>
			<td width="94"><span class="style12">District</span></td>
            <td width="120"><span class="style12">State</span></td>
			<td width="120"><span class="style12">Timing</span></td>
			<td width="100"><span class="style12">Base Price</span></td>
			<td width="100"><span class="style12">Per K.m Price</span></td>
			<td width="100"><span class="style12">Distance</span></td>			
			</tr>
			 </thead>
			<tbody>
			<% 
			...
			<td><span class="style12"><%=rs.getString(3)%></span></td>
			<td><span class="style12"><%=rs.getString(4)%></span></td>
			<td><span class="style12"><%=rs.getString(5)%></span></td>
			<td><span class="style12"><%=rs.getString(6)%></span></td>
			<td><span class="style12"><%=rs.getString(7)%></span></td>
			<td><span class="style12"><%=rs.getString(8)%></span></td>
			<td><span class="style12"><%=rs.getString(9)%></span></td>
			<td><span class="style12"><%=rs.getString(10)%></span></td>
			<td><span class="style12"><%=rs.getString(11)%></span></td>
			<td><span class="style12"><%=rs.getString(12)%></span></td>
