...
<h5>
<form action="abooking1.jsp" method="get">
Choose Customer 
<select name="a1">
<%
try{
ResultSet rs=st.executeQuery("select * from customer where cid in (select distinct cid from booking1)");
while(rs.next()){
%>
...
rs.beforeFirst();
%>
<table width="802" border="1" cellpadding="5">
<tr>
