...
<tr><td width="120"><span class="style10">Name</span></td> 
<td width="379"><span class="style10"><%=rs.getString(2)%></span></td>
</tr>

<tr><td width="120"><span class="style10">Plot No</span></td>
<td><span class="style10"><%=rs.getString(3)%></span></td>
</tr>

<tr><td width="120"><span class="style10">Area</span></td>
<td><span class="style10"><%=rs.getString(4)%></span></td>
</tr>

<tr><td width="120"><span class="style10">City</span></td>
<td><span class="style10"><%=rs.getString(5)%></span></td>
</tr>

<tr><td width="120"><span class="style10">Pincode</span></td>
<td><span class="style10"><%=rs.getString(6)%></span></td>
</tr>

<tr><td width="120"><span class="style10">District</span></td>
<td><span class="style10"><%=rs.getString(7)%></span></td>
</tr>

<tr><td width="120"><span class="style10">State</span></td>
<td><span class="style10"><%=rs.getString(8)%></span></td>
</tr>

<tr><td width="120"><span class="style10">Phone</span></td>
<td><span class="style10"><%=rs.getString(9)%></span></td>
</tr>

<tr><td width="120"><span class="style10">Mail</span></td>
<td><span class="style10"><%=rs.getString(10)%></span></td>
</tr>
 

<tr><td width="120"><span class="style10">Timing</span></td>
...
<h4>View Test Details Here</h4>
 			 <table width="923"  height="65" border="1"  cellpadding="5">
			 <tr>
			 <td width="354"><span class="style10">Test Name</span></td>
			 <td width="144"><span class="style10">Fees</span></td>
			 <td width="192"><span class="style10">Days</span></td>
			 </tr>
			 <% 
			  qry="select a.*,b.* from lab a,organisation b where a.oid='"+name+"'  and b.oid='"+name+"' ";
			 //out.print(qry);
			 ...
			 %>
			<tr>
			<td height="29"><span class="style10"><%=rs.getString(3)%></span></td>
			<td><span class="style10"><%=rs.getString(4)%></span></td>
			<td><span class="style10"><%=rs.getString(5)%></span></td>
			</tr>
			<% }
