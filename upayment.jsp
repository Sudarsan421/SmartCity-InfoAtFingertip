...
try{
String qry="select a.*, b.*, c.*, d.*  from booking1 a, room b, hotel c, place d where a.cid='"+cid+"' and a.rid=b.rid and a.hid=c.hid and a.pid=d.pid and  a.bid not in (select bid from payment) order by a.bkdt desc";
//out.print("<br>"+qry+"<br>");
ResultSet rs = st.executeQuery(qry);
if(rs.next()){
rs.beforeFirst();
%>
<table width="771" border="1" cellpadding="5">
<tr>
...
<td width="77"><span class="style2">Action</span></td>
</tr>
<%
while(rs.next()){
%>
...
<td><span class="style2"><span class="style13"><a href="upayment1.jsp?a1=<%=rs.getString(1)%>">Pay Now</a></span></td>
</tr>
<%
}
%>
