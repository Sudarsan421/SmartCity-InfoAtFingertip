...
<form  name="f2" id="f2" method="get" action="hcontactus1.jsp">
  <img src="fb.jpg" alt="" width="530" height="188" border="1" />
  <%
try{
    String s1=(String) session.getAttribute("id");
	String qry="select b.* from login a,organisation b where a.id='"+s1+"' and a.id=b.oid and a.type='hospital' ";
	//out.print(qry);
...
<table>
<tr>
<td width="289"><h2>Hospital Name:</h2></td>
