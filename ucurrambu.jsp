...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <br />
	<h4>  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to View Current Ambulance Booking</h4> <div class="article">


			 <%
			try{
			String qry1="select * from booking   where uid='"+(String)session.getAttribute("id")+"' and type='Ambulance' and (status='Pending' or status='Approved' ) order by(bookfromdate) ";
			//out.print(qry1);
			...
			<tr>
			<td width="110"><span class="style18">Booking ID</span></td> 
			<td width="30"><span class="style18">Vehicle ID</span></td>
			<td width="40"><span class="style18">Booked From Date</span></td>
			<td width="40"><span class="style18">Booked From Time</span></td>
			<td width="94"><span class="style18">User ID</span></td>
			<td width="68"><span class="style18">Type</span></td>
            <td width="120"><span class="style18">Status</span></td>
			</tr>
			<% while(rs.next()){ 	%>
			<tr>
			<td height="29"><span class="style18"><%=rs.getString(1)%></span></td>
			<td><span class="style18"><%=rs.getString(2)%></span></td>
