...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <br />
	<h4>  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to View Current Mortuary Van Booking</h4> <div class="article">




 		<form method="get" action="vbookingview1.jsp">
			<%
			try{
			//String qry="select a.* from booking a,login b  where a.uid='"+(String)session.getAttribute("id")+"' and a.status='Complete' and a.uid=b.id";
			  //out.print(qry);
			//  ResultSet rs=st.executeQuery(qry);
			 ...
			 <%
			try{
			String qry1="select * from booking   where uid='"+(String)session.getAttribute("id")+"' and type='Mortuary Van' and (status='Pending' or status='Approved') order by(bookfromdate)";
			//out.print(qry1);
			...
			<td width="68"><span class="style21">Type</span></td>
