...
<div class="main">
  ...
  <div class="content">
	...
	<br />  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to View BloodBank's Around You    <br /> <br />    
  <div class="article">
  
  
		<form method="post" action="ubloodbank1.jsp">
			<%
			try{
			  ResultSet rs=st.executeQuery("select a .* from organisation a,login b where a.oid=b.id and b.status='y' and a.type='BloodBank'");
			 %>	
			 <table>
			<tr><td><span class="style6">Choose BloodBank</span></td>
			<td></td>
			<td><select name="em">
			<% while(rs.next()){%>
			...
			<td><input type="submit"  class="myButton" value="Go"></td><td></td><td></td><td></td>
			<td><a href="ubldavl.jsp" class="myButton">Blood Availability</a></td> 
			</tr>
			</table>
...
<button class="sort-table desc">Sort Farthest First</button>
			...
			<%}catch(Exception ee){}%>
			 ...
			 <%
			try{
			 ResultSet rs=st.executeQuery("select a .* from organisation a,login b where a.oid=b.id and b.status='y' and a.type='BloodBank' limit 15");
			%>	
			...
			<table width="923"  height="65" border="1"  cellpadding="5" id="loctable">
				 <thead>
			<tr>
			<td width="110"><span class="style7 style7 style4"><strong>Name</strong></span></td> 
			<td width="30"><span class="style7 style7 style4"><strong>Plot No</strong></span></td>
			<td width="40"><span class="style7 style7 style4"><strong>Area</strong></span></td>
			<td width="40"><span class="style7 style7 style4"><strong>City</strong></span></td>
			<td width="68"><span class="style7 style7 style4"><strong>Pincode</strong></span></td>
			<td width="99"><span class="style7 style7 style4"><strong>District</strong></span></td>
			<td width="94"><span class="style7 style7 style4"><strong>State</strong></span></td>
            <td width="120"><span class="style7 style7 style4"><strong>Phone</strong></span></td>
			<td width="120"><span class="style7 style7 style4"><strong>Mail</strong></span></td>
			<td width="100"><span class="style7 style7 style4"><strong>Timing</strong></span></td>
			<td width="100"><span class="style7 style7 style4"><strong>Distance</strong></span></td>			
			</tr>
			 </thead>
			<tbody>
			<% 
			...
			<td height="29">
				...
				<strong><%=rs.getString(2)%></strong></span></td>
			<td><span class="style10 style5 style4"><strong><%=rs.getString(3)%></strong></span></td>
			<td><span class="style10 style5 style4"><strong><%=rs.getString(4)%></strong></span></td>
			<td><span class="style10 style5 style4"><strong><%=rs.getString(5)%></strong></span></td>
			<td><span class="style10 style5 style4"><strong><%=rs.getString(6)%></strong></span></td>
			<td><span class="style10 style5 style4"><strong><%=rs.getString(7)%></strong></span></td>
			<td><span class="style10 style5 style4"><strong><%=rs.getString(8)%></strong></span></td>
			<td><span class="style10 style5 style4"><strong><%=rs.getString(9)%></strong></span></td>
			<td><span class="style10 style5 style4"><strong><%=rs.getString(10)%></strong></span></td>
			<td><span class="style10 style5 style4"><strong><%=rs.getString(12)%></strong></span></td>
			<td class="style10 style5 distance style4" id="distance_<%=i%>"></td>	
			</tr>
			 <%
			 	i++;
			  }
