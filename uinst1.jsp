...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="about.jsp">Smart City</a><a href=""><small>Info at Fingure tip</small></a></h1>
      </div>
      <div class="menu_nav">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to Institute Information <div class="article">
...
<tr><td>
	<table width="515" height="384"  cellpadding="5">
				<tr><td width="217"><span class="style7">Name</span></td>
				<td width="270"><span class="style7"></span>  <a  href="<%=str %>" target="_parent"	 ><%=rs.getString(2)%></a> </td>
				</tr>   
				<tr><td><span class="style7">Type</span></td>
				<td><span class="style7"><%=rs.getString(3)%></span></td>
				</tr>
				<tr><td><span class="style7">Date of Registration</span></td>
				...
				<tr><td><span class="style7">Phone</span></td>
				<td><span class="style7"><%=rs.getString(7)%></span></td>
				</tr>
				<tr><td><span class="style7">Alt. Phone</span></td>
				<td><span class="style7"><%=rs.getString(8)%></span></td>
				</tr>
				<tr><td><span class="style7">Mail ID</span></td>
				<td><span class="style7"><%=rs.getString(9)%></span></td>
				</tr>
				<tr><td><span class="style7">About</span></td> 
				<td><span class="style7"><%=rs.getString(10)%></span></td>
				</tr> 
	</table>
</td><td><img src="./images/inst/<%=rs.getString(6)%>" width="420" height="300" alt="no photo" /></td>
</tr>
</table>
<% }  %>  	 
		
		
<h4>View Course Details Here</h4>
<% 
...
<table width="942" border="1" cellpadding="4">
  <tr> 
<td width="165"><span class="style16 style7">Course</span></td>
<td width="95"><span class="style16 style7">Fee</span></td>
<td width="79"><span class="style16 style7">Duration (days)</span></td>
<td width="65"><span class="style16 style7">Timing (hrs)</span></td>
<td width="106"><span class="style16 style7">StartsOn</span></td>
<td width="356"><span class="style16 style7">Description</span></td> 
</tr>


<%    while(rs.next()) {   %>
<tr>
<td><span class="style16 style7"><%=rs.getString(3)%></span></td>
<td><span class="style16 style7"><%=rs.getString(4)%></span></td>
<td><span class="style16 style7"><%=rs.getString(5)%></span></td>
<td><span class="style16 style7"><%=rs.getString(6)%></span></td>
<td><span class="style16 style7"><%=rs.getString(7)%></span></td>
<td><span class="style16 style7"><%=rs.getString(8)%></span></td>  
</tr>
<%    }   %>
</table>
<%
...
%>	
 ...
 <form method="get" action="uinst2.jsp">
			<%
			try{
			  ResultSet rs=st.executeQuery("select a.* from link a,login b where a.id=b.id and b.status='y' and b.type='link'");
			 %>	
			 <table>
			<tr><td><span class="style6">Choose Institute</span></td>
			<td></td>
			<td><select name="em">
			<% while(rs.next()){%>
