...
<form  name="f2" id="f2" method="post" action="uambbook.jsp">
...
<tr><td width="120"><span class="style15">Vehicle Number</span></td> 
<td width="379"><span class="style15"><%=rs.getString(2)%></span></td>
</tr>

<tr><td width="120"><span class="style15">Model</span></td>
<td><span class="style15"><%=rs.getString(3)%></span></td>
</tr>

<tr><td width="120"><span class="style15">Owner Name</span></td>
<td><span class="style15"><%=rs.getString(4)%></span></td>
</tr>

<tr><td width="120"><span class="style15">Driver Name</span></td>
<td><span class="style15"><%=rs.getString(5)%></span></td>
</tr>

<tr><td width="120"><span class="style15">Booking Number</span></td>
<td><span class="style15"><%=rs.getString(6)%></span></td>
</tr>

<tr><td width="120"><span class="style15">City</span></td>
<td><span class="style15"><%=rs.getString(7)%></span></td>
</tr>

<tr><td width="120"><span class="style15">District</span></td>
<td><span class="style15"><%=rs.getString(8)%></span></td>
</tr>

<tr><td width="120"><span class="style15">State</span></td>
<td><span class="style15"><%=rs.getString(9)%></span></td>
</tr>

<tr><td width="120"><span class="style15">Timing</span></td>
<td><span class="style15"><%=rs.getString(10)%></span></td>
</tr>
 

<tr><td width="120"><span class="style15">BasePrice</span></td>
<td><span class="style15"><%=rs.getString(11)%></span></td>
</tr>

<tr><td width="120"><span class="style15">Per Km Price</span></td>
<td><span class="style15"><%=rs.getString(12)%></span></td>
</tr>

<tr><td width="120"><span class="style15">Availability</span></td>
