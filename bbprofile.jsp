...
<div class="main">
  ...
  <div class="content">
	...
	<br />  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to BloodBank Profile    <br /> <br />    
  <div class="article">
...
try{
	...
	ResultSet rs=st.executeQuery("select b. * from login a,organisation b where a.id='"+s1+"' and a.id=b.oid and a.type='Bloodbank'");
	if(rs.next()){
%>
    <form method="post" action="bbprofile1.jsp">
	<table width="708">
