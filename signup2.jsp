...
<form action="signup3.jsp">
            ...
            <table width="841" height="283">
              <tr>
                <td width="150">Login Name </td>
                <td width="294"><input type="text" name="logname" value="<%=request.getParameter("aa1")%>" readonly="true"/></td>
				 <td width="138">Inst. Type</td>
                <td width="239"><select name="type">
			  ...
			  <tr>
                ...
                <td><input type="password" name="cpwd" placeholder="Password"/></td>
              </tr>
			  <tr>
                <td>Current Address</td>
                <td><textarea name="cadd" rows="6" cols="35"></textarea></td>
                <td> About Institute</td>
                <td><textarea name="about" rows="6" cols="35"></textarea></td>
              </tr>
              <tr>
                <td>Phone</td>
                <td><input type="text" name="phone1" placeholder="Phone No" /></td>
                <td>Alternate Phone</td>
                <td><input type="text" name="phone2" placeholder="Alternate Phone No" /></td>
              </tr>
              <tr>
                <td>Mail ID</td>
                <td><input type="mail" name="mail" placeholder="Contact Mail Id" /></td> 
                <td></td>
              </tr>
			   <tr>
                <td>Security Question</td>
                <td><select name="secques">
				<option selected="selected">Choose security Question</option>
				<option value="When the Organization is found ?">When the Organization is found ?</option>
				<option value="Who founded the organization ?">Who founded the organization ?</option>
				</select></td>
