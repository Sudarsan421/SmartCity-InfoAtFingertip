...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <form method="get" action="uinst1.jsp">
			<%
			try{
...
<button class="sort-table desc">Sort Farthest First</button>
			...
			<%}catch(Exception ee){}%>
			 ...
			 <%
			try{
			 ResultSet rs=st.executeQuery("select a.* from institute a,login b where a.instid=b.id and b.status='y' and b.type='Institute' limit 15");
			%>	
