...
<h4 class="title">Welcome <%= ((String)session.getAttribute("name")).toUpperCase() %> to View Available Blood!</h4><div class="article">
<br />
<form action="ubldavl1.jsp" method="get">
...
<tr><td width="41"><span class="style10">Slno</span></td>
<td width="132"><span class="style10">Organisation Name</span></td>
<td width="155"><span class="style10">Address</span></td>
<td width="96"><span class="style10">Phone</span></td> 
<td width="117"><span class="style10">Mail</span></td> 
<td width="65"><span class="style10">Blood Group</span></td>
<td width="53"><span class="style10">Rh Factor</span></td>
<td width="53"><span class="style10">Unit</span></td> 
</tr>
<%	while(rs.next()){	%>

<tr><td><span class="style10"><%=cnt++ %></span></span></td>
<td><span class="style10"><%=rs.getString(7)%></span></span></td>
<td><span class="style10"><%=rs.getString(8)+" "+rs.getString(9)+" "+rs.getString(10)%></span></span></td>
<td><span class="style10"><%=rs.getString(14)%></span></span></td>
<td><span class="style10"><%=rs.getString(15)%></span></span></td>

<td><span class="style10"><%=rs.getString(3)%></span></span></td>
<td><span class="style10"><%=rs.getString(4)%></span></span></td>
<td><span class="style10"><%=rs.getString(5)%></span></span></td> 
</tr>
<%	}	%>
</table>
<%
