...
String qry="update institute set name='"+name+"', type='"+type+"', phone1='"+phone1+"', phone2='"+phone2+"', mail='"+mail+"', cadd='"+cadd+"', about='"+about+"', lati='"+lati+"', longi='"+longi+"' where instid='"+instid+"'";
//out.print("<br>"+qry+"<br>");
st.executeUpdate(qry);
out.print("<font Color=green size=3>Profile Updated Successfully</font></br>");
