...
.style21 {font-size: 12px; color: #000000; font-weight: bold; }
 </style>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <br />
	<h4>  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %>  to View Mortuary Van Booking History</h4> <div class="article">

<%
try{
String qry="select * from booking where uid='"+(String)session.getAttribute("id")+"' and type='Mortuary Van' and status='Complete' order by(bookfromdate)";
  //out.print(qry);
  ResultSet rs=st.executeQuery(qry);
}catch(Exception ee){}

try{
	String qry1="select * from booking   where uid='"+(String)session.getAttribute("id")+"' and type='Mortuary Van' and status='Complete' order by(bookfromdate)";
		    //out.print(qry1);
			...
			<tr>
			<td width="110"><span class="style21">Booking ID</span></td> 
			<td width="30"><span class="style21">Vehicle ID</span></td>
			<td width="40"><span class="style21">Booked From Date</span></td>
			<td width="40"><span class="style21">Booked From Time</span></td>
			<td width="40"><span class="style21">Booked Till Date</span></td>
			<td width="40"><span class="style21">Booked Till Time</span></td>
			<td width="68"><span class="style21">Distance</span></td>
			<td width="99"><span class="style21">Price</span></td>
			<td width="94"><span class="style21">User ID</span></td>
			<td width="94"><span class="style21">Type</span></td>
            <td width="120"><span class="style21">Status</span></td>
			</tr>
			<% while(rs.next()){ 	%>
			<tr>
			<td height="29"><span class="style21"><%=rs.getString(1)%></span></td>
			<td><span class="style21"><%=rs.getString(2)%></span></td>
			<td><span class="style21"><%=rs.getString(5)%></span></td>
			<td><span class="style21"><%=rs.getString(6)%></span></td>
			<td><span class="style21"><%=rs.getString(7)%></span></td>
			<td><span class="style21"><%=rs.getString(8)%></span></td>
			<td><span class="style21"><%=rs.getString(9)%></span></td>
			<td><span class="style21"><%=rs.getString(10)%></span></td>
			<td><span class="style21"><%=rs.getString(11)%></span></td>
			<td><span class="style21"><%=rs.getString(12)%></span></td>	
			<td><span class="style21"><%=rs.getString(13)%></span></td>			
			</tr>
			 <% }
			 	%> 
			  </table>
