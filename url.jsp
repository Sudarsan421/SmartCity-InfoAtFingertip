...
<div class="main">
  ...
  <div class="content">
	...
	<br />  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to User Home    <br /> <br />    
  <div class="article">
  <h2><span><span class="style4">Please Confirm to <a href="www.kiit.ac.in">kiit</a></span></h2>
