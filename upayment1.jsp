...
float amt=0;
try{
String qry="select *  from booking1 where bid='"+s1+"'";
//out.print("<br>"+qry+"<br>");
ResultSet rs = st.executeQuery(qry);
if(rs.next()){  
amt=rs.getFloat(10);
%>
<form action="upayment2.jsp">
<input type="hidden" name="a1" value="<%=s1%>" />
<table width="315">
<tr><td><span class="style32 style2">Bank Name</span></td> 
<td><input name="bname" type="text" /></td>
</tr> 
<tr><td><span class="style32 style2">Card Number</span></td> 
<td><input name="cardno" type="text" /></td>
</tr>
<tr><td><span class="style32 style2">Account No.</span></td> 
<td><input name="acno" type="text" /></td>
</tr>
<tr><td><span class="style32 style2">amount</span></td> 
<td><input name="amount" type="text" value="<%=amt%>" readonly="true" /></td>
</tr>
<tr><td></td> 
