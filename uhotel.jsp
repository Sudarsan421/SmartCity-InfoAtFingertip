...
<div class="main">
 ...
 <form action="uhotel1.jsp" method="get">
<span class="style1">Choose Place</span> 
<select name="p1">
<% 
try{
...
while(rs.next()){
%>
	<option value="<%=rs.getString(1)%>"><%=rs.getString(9)+ " : " +rs.getString(4)%></option>
<%
}
}catch(Exception e){  }
%>
...
<% 
try{
ResultSet rs= st.executeQuery("select * from hotel a, place b where a.pid=b.pid limit 10");
%>
<table width="622">
<tr style="border:double #6666FF">
<td width="63" height="25"><span class="style2"> Place </span></td>
<td width="80"><span class="style2">Name</span></td>
<td width="76"><span class="style2">Type</span></td>
<td width="99"><span class="style2">Phone</span></td>
<td width="102"><span class="style2">Address</span></td>
<td width="109"><span class="style2">Location</span></td> 
</tr>
