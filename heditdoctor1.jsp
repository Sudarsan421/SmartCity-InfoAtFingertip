...
<div class="main">
  ...
  <div class="content">
	...
	<br />  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to Update Doctor    <br /> <br />    
  <div class="article">
			...
			%>	
<form  name="f2"  method="post" action="heditdoctor2.jsp">
	<table width="708">
	<tr>
	    <td>Doctor ID </td>
		<td><input type="text" name="doid"  value="<%=rs.getString(1)%>" readonly="true"/></td>
		<td></td></tr><tr>
		<td>Organisation ID </td>
		<td><input type="text" name="oid" value="<%=session.getAttribute("id")%>" readonly="true" /></td>
		<td></td></tr><tr>
		<td>Department ID </td>
		<td><input type="text" name="depid"  value="<%=rs.getString(3)%>" readonly="true"/></td>
		<td></td></tr><tr>
		<td>Name</td>
	 ...
	 <tr>
		<td>Fee</td>
		<td><input type="text" name="fee"   value="<%=rs.getString(6)%>"/></td>
		<td></td>
	   </tr>
	 <tr>
		<td>Days</td>
		<td><input type="text" name="days"  value="<%=rs.getString(7)%>"/></td></tr>
		</tr>
