...
st.executeUpdate("update hotel set type='"+type+"', name='"+name+"', phno='"+phno+"', address='"+address+"', loca='"+loca+"' where hid='"+s1+"'");
out.print("<font color=green >Hotel Information is Updated Successfully.</font>");
con.close();
