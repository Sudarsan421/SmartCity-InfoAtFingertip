...
<div class="main">
  ...
  <div class="content">
	...
	<br />  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to Contact Us    
  <div class="article">
  

<form  name="f2" id="f2" method="get" action="ucontactus1.jsp">
...
<table>
<tr>
<td width="289"><span class="style14">Name:</span></td>
<td width="630"><input name="name" type="text" value="<%=rs.getString(2)%>" readonly="true"/></td>
</tr>
<tr>
  <td><span class="style14">Email Address </span></td>
  <td><input name="email" type="text"  value="<%=rs.getString(9)%>"   readonly="true"/></td>
</tr>
<tr><td><span class="style14">Phone Number </span></td>
<td> <input name="phone" type="text" value="<%=rs.getString(8)%>"  /> </td>
</tr>
<tr><td> <span class="style14">Your Message  </span></td>
