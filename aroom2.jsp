...
try{
st.executeUpdate("update room set size='"+size+"', facility='"+facility+"', price="+price+", noroom="+noroom+" where rid='"+rid+"'");
out.print("<font color=green>Room Detail is Updated.</font>");
con.close();
