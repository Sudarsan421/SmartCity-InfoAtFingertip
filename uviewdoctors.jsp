    ...
    <div class="content_resize">
	  ...
	  <br />
            ...
            //out.print(qry);
			 ...
			 %>	
			<h4>Welcome <%=((String)session.getAttribute("name")).toUpperCase() %> to View <%=str2%> Doctors Here!</h4> <div class="article">
			 
				<table width="923"  height="65" border="1"  cellpadding="5">
			<tr>
			<td width="72"><span class="style7">Doctor ID</span></td> 
			 
			<td width="87"><span class="style7">Department Name</span></td>
			<td width="196"><span class="style7">Name</span></td>
			<td width="121"><span class="style7">Timing</span></td>
			<td width="31"><span class="style7">Fee</span></td>
			<td width="188"><span class="style7">Days</span></td>
			</tr>
			<% while(rs.next()){ 	%>
			<tr>
			<td height="29" align="left" valign="top"><span class="style7"><%=rs.getString(1)%></span></td>
			<td align="left" valign="top"><span class="style7"><%=str2%></span></td>
			<td align="left" valign="top"><span class="style7"><%=rs.getString(4)%></span></td>
			<td align="left" valign="top"><span class="style7"><%=rs.getString(5)%></span></td>
			<td align="left" valign="top"><span class="style7"><%=rs.getString(6)%></span></td>
			<td align="left" valign="top"><span class="style7"><%=rs.getString(7)%></span></td>
			</tr>
			 <% }
			 	%> 
			  </table>
