...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <br />
	  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to Pending Blood Donation
        <div class="article">
	   <%
try{ 
...
rs.beforeFirst();
%>
<table width="741" border="1" cellpadding="3">
<tr><td width="225"><span class="style7">Name</span></td>
<td width="225"><span class="style7">Organisation</span></td>
<td width="225"><span class="style7">City</span></td>
...
<td><span class="style10"><%=rs.getString(23)%></span></td>
<td><span class="style10"><%=rs.getString(26)%></span></td>
