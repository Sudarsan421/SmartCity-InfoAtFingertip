...
<div class="main">
  ...
  <div class="content">
	...
	<br />  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to Feedback History   <div class="article">
		 ...
		 <%
			...
			<tr>
			<td width="85"><span class="style19">Feedbackid</span></td> 
			<td width="56"><span class="style19">ID</span></td>
			<td width="67"><span class="style19">Date of Feedback</span></td>
			<td width="57"><span class="style19">Type of User</span></td>
			<td width="59"><span class="style19">Name</span></td>
			<td width="106"><span class="style19">Email</span></td>
			<td width="101"><span class="style19">Phone</span></td>
            <td width="129"><span class="style19">Message</span></td>
			<td width="133"><span class="style19">Current Status</span></td>
			<td width="129"><span class="style19">Reply</span></td>
			</tr>
			<% while(rs.next()){ 	%>
			<tr>
			<td height="29">
			  <span class="style19"><span class="style10  style5"><strong><%=rs.getString(1)%></span></td>
			<td><span class="style19"><%=rs.getString(2)%></span></td>
			<td><span class="style19"><%=rs.getString(3)%></span></td>
			<td><span class="style19"><%=rs.getString(4)%></span></td>
