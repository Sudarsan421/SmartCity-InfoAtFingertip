...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <br /> 
	<h4>Welcome <%= ((String)session.getAttribute("name")).toUpperCase() %> To View PathLab's Around You !</h4><div class="article">
		<form method="post" action="upathlab1.jsp">
			<%
			try{
			  ResultSet rs=st.executeQuery("select a .* from organisation a,login b where a.oid=b.id and b.status='y' and a.type='Path Lab'");
			 %>	
			 <table>
			<tr><td><span class="style6">Choose PathLab</span></td>
			<td></td>
			<td><select name="em">
			<% while(rs.next()){%>
...
<button class="sort-table desc">Sort Farthest First</button> 
			...
			<%}catch(Exception ee){}%>
			 ...
			 <%
			try{
			 ResultSet rs=st.executeQuery("select a .* from organisation a,login b where a.oid=b.id and b.status='y' and a.type='Path Lab' limit 15");
			%>	
			...
			<table width="923"  height="65" border="1"  cellpadding="5" id="loctable">
				 <thead>
			<tr>
			<td width="110"><span class="style7">Name</span></td> 
			<td width="30"><span class="style7">Plot No</span></td>
			<td width="40"><span class="style7">Area</span></td>
			<td width="40"><span class="style7">City</span></td>
			<td width="68"><span class="style7">Pincode</span></td>
			<td width="99"><span class="style7">District</span></td>
			<td width="94"><span class="style7">State</span></td>
            <td width="120"><span class="style7">Phone</span></td>
			<td width="120"><span class="style7">Mail</span></td>
			<td width="100"><span class="style7">Timing</span></td>
			<td width="100"><span class="style7">Distance</span></td>			
			</tr>
			 </thead>
			<tbody>
			<% 
			...
			<td height="29">
				...
				<span class="style10  style5"><strong><%=rs.getString(2)%></span></td>
