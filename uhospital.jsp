...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <br />
	  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to Hospital Information <div class="article">
	  <form method="post" action="uhospital1.jsp">
			<%
			try{
			  ResultSet rs=st.executeQuery("select a.* from organisation a,login b where a.oid=b.id and b.status='y' and a.type='Hospital'");
			 %>	
			 <table>
			<tr><td><span class="style6">Choose Hospital</span></td>
			<td></td>
			<td><select name="em">
			<% while(rs.next()){%>
...
<button class="sort-table desc">Sort Farthest First</button>
			...
			<%}catch(Exception ee){}%>
			 ...
			 <%
			try{
			 ResultSet rs=st.executeQuery("select a.* from organisation a,login b where a.oid=b.id and b.status='y' and a.type='Hospital' limit 15");
			%>	

			<form method="post" name="latilongiform" action="">
			<table width="923"  height="65" border="1"  cellpadding="5" id="loctable" border="1" >
				 <thead>
			<tr>
			<td width="110"><span class="style4"> Name</span></td> 
			<td width="30"><span class="style4">Plot No</span></td>
			<td width="40"><span class="style4">Area</span></td>
			<td width="40"><span class="style4">City</span></td>
			<td width="68"><span class="style4">Pincode</span></td>
			<td width="99"><span class="style4">District</span></td>
			<td width="94"><span class="style4">State</span></td>
            <td width="120"><span class="style4">Phone</span></td>
			<td width="120"><span class="style4">Mail</span></td>
			<td width="100"><span class="style4">Timing</span></td>
			<td width="100"><span class="style4">Distance</span></td>			
			</tr>
			 </thead>
			<tbody>
			<% 
			...
			<td><span class="style4"><%=rs.getString(9)%></span></td>
			<td><span class="style4"><%=rs.getString(10)%></span></td>
			<td><span class="style4"><%=rs.getString(12)%></span></td>
			<td class="distance style4" id="distance_<%=i%>"></td>	
			</tr>
			 <%
			 	i++;
			  }
