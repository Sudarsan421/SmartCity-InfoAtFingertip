...
<form method="post"  action="umortbook1.jsp">
<table width="708">
	<tr> 
		<td><span class="style18">Vehicle Number</span></td>
		<td><input name="vno" type="text" value="<%=request.getParameter("vno")%>" readonly="true" /></td>
		<td></td>
		<td><span class="style18">Vehicle ID </span></td>
		<td><input name="vid" type="text" value="<%=request.getParameter("vid")%>" readonly="true" /></td>
		<td></td>
		</tr>
		<td><span class="style18">Type</span></td>
		<td><input name="type" type="text" value="<%=request.getParameter("type")%>" readonly="type" /> </td>
		<td></td>
		<td><span class="style18">Model</span></td>
		<td><input name="model" type="text" value="<%=request.getParameter("model")%>" readonly="true"/></td>
		</tr>
		<tr>
		<td><span class="style18">User ID</span></td>
		<td><input name="uid" type="text" value="<%=((String)session.getAttribute("id"))%>" readonly="true"/ ></td>
		<td></td>
		</tr>
		<td><span class="style18">Book From Date</span></td>
		<td><input name="bookfromdate" type="date"></td>
	    <td><span class="style18">Book From Time</span></td>
		<td><input name="bookfromtime" type="time"></td>
	</tr>
	<tr>
		 <tr>
	   <td><span class="style18">Latitude</span></td>
	   <td><input name="lat" type="text" id="lat"></td>
	   <td></td>
	   <td><span class="style18">Longitude</span></td>
...
<h2>Select Your Pickup Location Here</h2>
