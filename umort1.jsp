...
%>	   
<% 
			 String qry="select * from vehicle  where vid='"+name+"'   ";
			// out.print(qry);
...
%>
<h4>Welcome <%= ((String)session.getAttribute("name")).toUpperCase() %> to View <%=rs.getString(2)%> Information!</h4><div class="article">
<form  name="f2" id="f2" method="post" action="umortbook.jsp">
...
<input type="hidden" name="type" value="<%=rs.getString(16)%>"/>
<input type="submit"  class="myButton" value="Book Now">
</form>
<table>
<tr><td>
<table width="515" height="384"  cellpadding="5">
<tr><td width="120"><span class="style18">Vehicle Number</span></td> 
<td width="379"><span class="style18"><%=rs.getString(2)%></span></td>
</tr>

<tr><td width="120"><span class="style18">Model</span></td>
<td><span class="style18"><%=rs.getString(3)%></span></td>
</tr>

<tr><td width="120"><span class="style18">Owner Name</span></td>
<td><span class="style18"><%=rs.getString(4)%></span></td>
</tr>

<tr><td width="120"><span class="style18">Driver Name</span></td>
<td><span class="style18"><%=rs.getString(5)%></span></td>
</tr>

<tr><td width="120"><span class="style18">Booking Number</span></td>
<td><span class="style18"><%=rs.getString(6)%></span></td>
</tr>

<tr><td width="120"><span class="style18">City</span></td>
<td><span class="style18"><%=rs.getString(7)%></span></td>
</tr>

<tr><td width="120"><span class="style18">District</span></td>
<td><span class="style18"><%=rs.getString(8)%></span></td>
</tr>

<tr><td width="120"><span class="style18">State</span></td>
<td><span class="style18"><%=rs.getString(9)%></span></td>
</tr>

<tr><td width="120"><span class="style18">Timing</span></td>
<td><span class="style18"><%=rs.getString(10)%></span></td>
</tr>
 

<tr><td width="120"><span class="style18">BasePrice</span></td>
<td><span class="style18"><%=rs.getString(11)%></span></td>
</tr>

<tr><td width="120"><span class="style18">Per Km Price</span></td>
<td><span class="style18"><%=rs.getString(12)%></span></td>
</tr>

<tr><td width="120"><span class="style18">Availability</span></td>
<td><span class="style18"><%=rs.getString(13)%></span></td>
</tr>
</table>			 

</td><td>
<img src="./images/orga/<%=rs.getString(17)%>" width="420" height="300" alt="no photo" />
</td></tr>
</table>
			<% }
            %>  	 
