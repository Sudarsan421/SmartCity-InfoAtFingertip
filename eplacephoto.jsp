...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <br />
	  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to Place Entry View  <br />       
        <div class="article">

<span class="style8">Click on image to Upload</span><br>
<% 
...
<a href="eplacephoto1.jsp?a1=<%=phid%>&a2=<%=("photo"+ i)%>"><img src="./images/photos/<%=img%>" width="232" height="200"></a>
<%	if(i%2==1){
		out.print("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");	
	}else{
		out.print("<br><br>");
