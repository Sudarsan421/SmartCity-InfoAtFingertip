...
<tr><td width="151"><span class="style10">Vehicle Number</span></td> 
<td width="336"><span class="style10"><%=rs.getString(2)%></span></td>
</tr>

<tr><td width="151"><span class="style10">Model</span></td>
<td><span class="style10"><%=rs.getString(3)%></span></td>
</tr>

<tr><td width="151"><span class="style10">Owner Name</span></td>
<td><span class="style10"><%=rs.getString(4)%></span></td>
</tr>

<tr><td width="151"><span class="style10">Driver Name</span></td>
<td><span class="style10"><%=rs.getString(5)%></span></td>
</tr>

<tr><td width="151"><span class="style10">Booking Contact</span></td>
<td><span class="style10"><%=rs.getString(6)%></span></td>
</tr>

<tr><td width="151"><span class="style10">City</span></td>
<td><span class="style10"><%=rs.getString(7)%></span></td>
</tr>

<tr><td width="151"><span class="style10">District</span></td>
<td><span class="style10"><%=rs.getString(8)%></span></td>
</tr>

<tr><td width="151"><span class="style10">State</span></td>
<td><span class="style10"><%=rs.getString(9)%></span></td>
</tr>

<tr><td width="151"><span class="style10">Timing</span></td>
<td><span class="style10"><%=rs.getString(10)%></span></td>
</tr>

<tr><td width="151"><span class="style10">Base Price</span></td>
<td><span class="style10"><%=rs.getString(11)%></span></td>
</tr>


<tr><td width="151"><span class="style10">Per K.m Price</span></td>
<td><span class="style10"><%=rs.getString(12)%></span></td>
</tr>


<tr><td width="151"><span class="style10">Availability</span></td>
<td><span class="style10"><%=rs.getString(13)%></span></td>
</tr>


<tr><td width="151"><span class="style10">Type</span></td>
