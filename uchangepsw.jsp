...
function verify(){
var p1=document.f1.epass.value;
var p2=document.f1.cpass.value;
 if(p1==""){
   alert("Enter password");
   document.f1.epass.focus();
   return false;
 } else if(p2==""){
...
<div class="main">
  ...
  <div class="content">
	...
	<br />  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to Change Password  <div class="article">
  

<% try{
%>
		<form name="f1" id="f1" action="uchangepsw1.jsp" method="post">
		 <table height="119">
		
		 <tr>
		 <td width="188"><span class="style6 style17">Enter New Password:</span></td>
		 <td width="244"><input name="epass" type="password" id="epass" /></td>
		 </tr>
		 <tr>
		 <td><span class="style6 style17">Enter Confirm password:</span></td>
		 <td><input name="cpass" type="password" id="cpass" /></td>
		 </tr>
		 
		<td height="35"></td> <td><input type="submit" value="Submit" onClick="return verify()" /></td>
		 </table>
		 </form>
		<%
con.close();
