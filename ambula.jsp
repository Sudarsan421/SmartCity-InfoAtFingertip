...
<div class="main">
  ...
  <div class="content">
	...
	<h4>  Welcome <%=((String) session.getAttribute("name")).toUpperCase() %> to View Ambulance's Around You !</h4> <div class="article">
		...
		<form method="post" action="ambula1.jsp">
			<%
			try{
			  ResultSet rs=st.executeQuery("select a.* from vehicle a,login b where a.vid=b.id and b.status='y' and a.availability='Y'  and a.type='Ambulance'");
			 %>	
			 <table>
